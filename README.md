...
**Live demo:** [CRM → ERP Payment Simulator](https://egovender.github.io/enterprise-architecture/) - an interactive, browser-only walkthrough of the CRM-to-ERP payment workflow described below.
